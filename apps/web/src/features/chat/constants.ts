...
// Deepgram "Asteria" — used when no voiceId is provided in the avatar config
export const DEFAULT_VOICE_ID = process.env.NEXT_PUBLIC_DEFAULT_VOICE_ID ?? "aura-2-asteria-en";

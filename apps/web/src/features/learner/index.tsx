...
function AskMeAnythingCard() {
  ...
  return (
    <button
      ...
      className="flex items-center gap-4 rounded-lg border border-dashed p-4 text-left transition-colors hover:bg-muted/50 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring w-full"
    >
      <div className="flex-1 min-w-0">
                ...
                <Accordion type="single" collapsible className="-mt-4">
                  <AccordionItem value="archive" className="border-none">
                    <AccordionTrigger className="py-2 text-sm text-muted-foreground hover:no-underline hover:text-foreground">
                      Archive&nbsp;
                      <span className="text-xs font-normal">({archive.length})</span>
                    </AccordionTrigger>
                    <AccordionContent>

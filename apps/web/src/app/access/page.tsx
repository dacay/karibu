...
import { useOrgPublic, externalIdLabelFor } from "@/hooks/useOrgPublic";
...
export default function AccessPage() {
  ...
  const enabled = org?.externalIdLoginEnabled ?? false;
  const label = externalIdLabelFor(org);
  const sessionHours = org?.externalIdSessionHours ?? 12;
